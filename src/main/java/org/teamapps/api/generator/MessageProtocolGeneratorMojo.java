...
@Mojo(name = "generate-message-protocol-api",
		defaultPhase = LifecyclePhase.GENERATE_SOURCES,
		requiresDependencyResolution = ResolutionScope.COMPILE)
public class MessageProtocolGeneratorMojo extends AbstractMojo {
	...
	@Parameter(defaultValue = "${project.build.directory}/generated-sources/message-protocol-api")
